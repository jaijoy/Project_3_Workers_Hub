...
class UserWorkerChatt extends StatefulWidget {
  const UserWorkerChatt({super.key});

  @override
  State<UserWorkerChatt> createState() => _UserWorkerChatState();
}
...
class _UserWorkerChatState extends State<UserWorkerChatt> {
  ...
  Future<void> loadInitialData() async {
    ...
    setState(() {
      ...
      otherId = pref.getString("chat_to_id") ?? "";
    });
  ...
  Future<void> viewMessages() async {
    try {
      var res = await http.post(
        Uri.parse("$url/myapp/chat_view_user/"),
        body: {
          "from_id": myId,
          "to_id": otherId,
        },
  ...
  Future<void> sendMessage() async {
    ...
    try {
      await http.post(
        Uri.parse("$url/myapp/user_chat_send/"),
        body: {
          "from_id": myId,
          "to_id": otherId,
