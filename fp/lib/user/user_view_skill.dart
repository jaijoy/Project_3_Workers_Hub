...
//
// class UserViewSkill extends StatefulWidget {
//   final String workerId;
//
//   const UserViewSkill({super.key, required this.workerId});
//
//   @override
//   State<UserViewSkill> createState() => _UserViewSkillState();
// }
//
// class _UserViewSkillState extends State<UserViewSkill> {
//   List skills = [];
//   bool loading = true;
//
//   @override
...
//         Uri.parse('$url/myapp/user_view_worker_skill/'),
//         body: {
//           'wid': widget.workerId,
//           'lid': lid,
//         },
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 10),
                Text(
                  "This worker hasn't added any skills yet",
                  style: TextStyle(
