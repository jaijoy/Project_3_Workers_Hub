...
void main() {
  runApp(const MyChatApps());
}

class MyChatApps extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const Workjer_User_Chat(title: 'Flutter Demo Home Page'),
    );
  }
}

class Workjer_User_Chat extends StatefulWidget {
  const Workjer_User_Chat({super.key, required this.title});

  final String title;

  @override
  State<Workjer_User_Chat> createState() => _Workjer_User_ChatState();
}
...
class _Workjer_User_ChatState extends State<Workjer_User_Chat> {
  int _counter = 0;
  String name = "";
  ...
  Future<void> view_message() async {
    ...
    try {
      ...
      String url = '$urls/myapp/worker_viewchat';
                  ...
                  FloatingActionButton(
                    onPressed: () async {
                      ...
                      try {
                        ...
                        String url = ip + "/myapp/worker_sendchat";
