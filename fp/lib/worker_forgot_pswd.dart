...
class wForgotPasswordPage extends StatefulWidget {
  const wForgotPasswordPage({super.key});
  // final String title;

  @override
  State<wForgotPasswordPage> createState() => _ForgotPasswordPageState();
}

class _ForgotPasswordPageState extends State<wForgotPasswordPage> with SingleTickerProviderStateMixin {
